    ...
    return <>
        <footer class="bg-gradient-to-r from-slate-900 via-slate-700 to-slate-900 py-10 px-10 font-sans tracking-wide">
            <div class="max-w-2xl mx-auto text-center">
                <h2 class="text-cyan-300">AJ.create.com</h2>
                <p class="text-sm mt-8 text-gray-300">
                    "The beauty of nature lies in its simplicity, captured in every detail of this majestic view."
                    <a href="javascript:void(0)" class="text-sm font-semibold text-blue-500">Read more...</a>
                </p>
            ...
            <ul class="grid max-sm:grid-cols-1 max-lg:grid-cols-2 lg:grid-cols-4 gap-12 mt-20">
                <li class="text-center max-sm:px-10 max-sm:py-4">
                    <h6 class="text-white font-semibold text-xl mb-2">Useful Links</h6>
                    <ul>
                        <li><a href="javascript:void(0)" class="text-gray-300 text-sm">Home</a></li>
                        <li><a href="javascript:void(0)" class="text-gray-300 text-sm">About</a></li>
                        <li><a href="javascript:void(0)" class="text-gray-300 text-sm">Services</a></li>
                        <li><a href="javascript:void(0)" class="text-gray-300 text-sm">Contact</a></li>
                    </ul>
                </li>

                <li class="text-center max-sm:px-10 max-sm:py-4">
                    <h6 class="text-white font-semibold text-xl mb-2">Quick Links</h6>
                    <ul>
                        <li><a href="javascript:void(0)" class="text-gray-300 text-sm">Privacy Policy</a></li>
                        <li><a href="javascript:void(0)" class="text-gray-300 text-sm">Terms & Conditions</a></li>
                        <li><a href="javascript:void(0)" class="text-gray-300 text-sm">FAQs</a></li>
                    </ul>
                </li>

                <li class="text-center max-sm:px-10 max-sm:py-4">
                    <h6 class="text-white font-semibold text-xl mb-2">Contact Us</h6>
                    <ul>
                        <li class="text-gray-300 text-sm">Email: jatish933@gmail.com</li>
                        <li class="text-gray-300 text-sm">Phone: 9373381354</li>
                    </ul>
                </li>

                <li class="text-center max-sm:px-10 max-sm:py-4">
                    <h6 class="text-white font-semibold text-xl mb-2">Follow Us</h6>
                    <ul class="flex flex-wrap justify-center gap-6 mt-8">
                        <li>
                            <a href="javascript:void(0)">
                                <svg xmlns="http://www.w3.org/2000/svg" class="fill-blue-600 w-8 h-8" viewBox="0 0 49.652 49.652">
            ...
            <div class="text-center mt-8">
                <p class="text-gray-300 text-sm">&copy; 2025 AJ.create.com. All rights reserved.</p>
            </div>
        </footer>
