...
import { useAddphotoGraferMutation } from '../../redux/admin/adminApi';

const AddPhotoGrafher = () => {
    const [registerUser, { isSuccess, isLoading, isError, error }] = useAddphotoGraferMutation();
    ...
    return (
        <>
            <form onSubmit={formik.handleSubmit}>
                <div className="flex flex-col justify-center items-center w-full h-[700px] bg-[#282D2D] px-4 sm:px-5">
                    <div className={`xl:max-w-3xl ${darkMode ? 'bg-black' : 'bg-white'} w-full p-4 sm:p-6 rounded-md`}>
                        <h1 className={`text-center text-xl sm:text-2xl font-semibold ${darkMode ? 'text-white' : 'text-black'}`}>
                            AddPhotoGrafher for a free account
                        </h1>
                        ...
                        <div className="w-full mt-6">
                            <div className="mx-auto max-w-xs sm:max-w-md flex flex-col gap-4">
                                ...
                                >
                                    <span className="ml-3">AddPhotoGrafher</span>
                                </button>
...
export default AddPhotoGrafher;
